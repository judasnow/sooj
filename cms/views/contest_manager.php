...
if( !empty( $this->contest_lists ) ){
	 ...
	 foreach( $rows as $index => $contest_list ){
		 ...
		 echo '<a href="/sooj/cms/contest_manager/modify_contest/id/' . $contest_list['id'] . '" >修改</a>';
		 echo '<a href="/sooj/cms/contest_manager/view_contest_result/id/' . $contest_list['id'] . '" >查看结果</a>';
		 echo '<a href="/sooj/cms/contest_manager/view_contest_reg_users/id/' . $contest_list['id'] . '" >查看报名情况</a></td>';
		 echo '</tr>';
	 }	
}
?>
