<?php /* Smarty version 2.6.26, created on 2011-06-18 02:51:52
...
?>
	 	 ...
	 	 <?php if ($this->_tpl_vars['key'] == 'id' || $this->_tpl_vars['key'] == 'sb_count' || $this->_tpl_vars['key'] == 'ac_count'): ?>
	 	 	 <?php continue; ?>
	 	 <?php endif; ?>
	 	 ...
	 	 <?php if ($this->_tpl_vars['key'] == 'head_img'): ?>
	 	 	 ...
	 	 	 <td class="head_img"><div class="head_img_div"><img src="<?php echo ((is_array($_tmp=$this->_tpl_vars['value'])) ? $this->_run_mod_handler('replace', true, $_tmp, 'big', 'small') : smarty_modifier_replace($_tmp, 'big', 'small')); ?>
" /></div></td>
	 	 	 <?php continue; ?> 
	 	 <?php endif; ?>
