<?php /* Smarty version 2.6.26, created on 2011-06-29 07:04:59
         compiled from code/code_submit.tpl */ ?>
...
<input type="hidden" name="problem_no" value="<?php echo $this->_tpl_vars['problem_no']; ?>
"/>
<!--当前代码信息-->
<p class="help">
	 	 <?php if ($this->_tpl_vars['problem_no']): ?>

	 	 <?php if ($this->_tpl_vars['contest_id']): ?>
	 
	 <span><a href="/sooj/controller/contest/ajax_view_contest_result.php?contest_id=<?php echo $this->_tpl_vars['contest_id']; ?>
">查看竞赛信息</a></span> 
	 
	 <?php endif; ?>
	 
	 <span><a href="/sooj/controller/problem/ajax_problem_detail.php?no=<?php echo $this->_tpl_vars['problem_no']; ?>
">查看试题:
	 	 <span class="helight"><?php echo $this->_tpl_vars['problem_no']; ?>
</span></a>
	 </span> 
...
<p class="control">
	 ...
	 <select name="language">
	 	 <option value="c">ANSI C ( GCC VER 2.4.5 )</option>
...
//查看题目详细
var ajax = new Control.Window($(document.body).down('[href=/sooj/controller/problem/ajax_problem_detail.php?no=<?php echo $this->_tpl_vars['problem_no']; ?>
]'),{  
...
var ajax = new Control.Window($(document.body).down('[href=/sooj/controller/contest/ajax_view_contest_result.php?contest_id=<?php echo $this->_tpl_vars['contest_id']; ?>
]'),{  
    className: 'simple_window contest_result_list',  
    closeOnClick: 'container',
    offsetLeft: 150
});
