...
<p class="help">
	 ...
	 <span><a href="/sooj/controller/contest/ajax_view_contest_result.php?contest_id={?$contest_id?}">查看竞赛信息</a></span> 
	 
	 {? /if ?}
	 
	 <span><a href="/sooj/controller/problem/ajax_problem_detail.php?no={?$problem_no?}">查看试题:
	 	 <span class="helight">{?$problem_no?}</span></a>
	 </span> 
...
var ajax = new Control.Window($(document.body).down('[href=/sooj/controller/contest/ajax_view_contest_result.php?contest_id={?$contest_id?}]'),{  
